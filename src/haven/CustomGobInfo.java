...
// not working, refreshing map...
    public boolean isTree() {
        CropInfo info = cropInfo.get();
        Resource res = gob.getres();
        return (info != null) && (info != CropInfo.empty) && (res.name.startsWith("gfx/terobjs/trees"));
    }

//becouse of above below is isCrop, change it later to isTree
    public boolean isHidden() {
        return Config.hidegobs && isCrop();
    }

    public Drawable getReplacement() {
        return Config.hidegobs ? replacement.get() : null;
    }
